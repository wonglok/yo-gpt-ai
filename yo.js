...
var main = function (myPrompt, res) {
  if (myPrompt === void 0) {
    myPrompt = "how are you";
  }
  return __awaiter(void 0, void 0, void 0, function () {
    var gpt4all, platform, stdout, modelPath, e_1;
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          return [
            4 /*yield*/,
            (0, util_1.promisify)(child_process_1.exec)("uname -m"),
          ];
        case 1:
        ...
        case 3:
          ...
          if (!!fs.existsSync(modelPath)) return [3 /*break*/, 5];
          return [
            4 /*yield*/,
            gpt4all.downloadFile(
        ...
        case 5:
          ...
          return [
            4 /*yield*/,
            fs.chmod(gpt4all.executablePath, 493, function (err) {
              if (err) {
                throw err;
              }
            }),
